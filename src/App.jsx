          ...
          <div className="container py-5">
            <div className="row">
              ...
              <div className="d-flex justify-content-between">
                <h2>產品列表</h2>
                <button onClick={() => handelOpenproductModal('create')} type="button" className="btn btn-primary">建立新的產品</button>
                </div>
                    ...
                    {products.map((product) => (
                      <tr key={product.id}>
                        ...
                        <div className="btn-group">
                          <button type="button" onClick={() => handelOpenproductModal('edit', product)} className="btn btn-outline-primary btn-sm">編輯</button>
                          <button type="button" onClick={() =>handelOpenDelproductModal(product)} className="btn btn-outline-danger btn-sm">刪除</button>
                        </div>
